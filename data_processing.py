...
# # **To Be Set**
forest_file = iio.imread(uri="/datalake/fdavis/Trees/data/50m_sections_unprocessed/sophia_FL012/RU_BP_TR2_FL012_train50a.tif")
labels = gpd.read_file("/datalake/fdavis/Trees/data/50m_sections_unprocessed/sophia_FL012/RU_BP_TR2_FL012_train50a_crowns_SG_bboxes.shx")
min_x, min_y, max_x, max_y = 2161398.7699114200659096,2439639.8628751100040972, 2161460.1782242199406028, 2439584.1068095099180937



tile_dimensions = 768

subset = "RU_BP_TR2_FL012_train50a_crowns_SG_tiles"
file_path = "/datalake/fdavis/Trees/data/sophia_FL012_50m_sections_processed/"
# # **To Be Set**
...
plt.show()
plt.savefig("padded_image_with_labels.png")
